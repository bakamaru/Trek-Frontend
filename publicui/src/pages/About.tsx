...
import { useGetAboutUsQuery } from '../redux/api/contentAPI';
...
const About: React.FC = () => {
  const { data: aboutData, isLoading, error } = useGetAboutUsQuery(undefined);
    ...
    <div className="pt-20">
      <section className="bg-gray-100 dark:bg-gray-800 py-20 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mt-4 max-w-3xl mx-auto">{content}</p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <img src={image} alt="Travelers enjoying a view" className="rounded-lg shadow-xl" />
            </div>
          </div>
        </div>
      </section>
