...
const TourBooking: React.FC<TourBookingProps> = () => {
    ...
    const totalPrice = useMemo(() => tour ? tour.price * numTravelers : 0, [tour, numTravelers]);
    ...
    if (!tour) {
        return <div className="pt-20 h-screen flex items-center justify-center"><h1 className="text-3xl font-bold">Tour Not Found</h1></div>;
    }
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <div className="lg:col-span-1">
                            <div className="sticky top-28 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border dark:border-gray-700">
                                ...
                                <img src={tour.image} alt={tour.title} className="rounded-lg mb-4" />
                                <h3 className="text-xl font-semibold dark:text-gray-200">{tour.title}</h3>
                                <div className="space-y-3 my-4 text-gray-600 dark:text-gray-300">
                                    ...
                                    <p className="flex justify-between"><span>Price per person:</span> <strong>${tour.price}</strong></p>
