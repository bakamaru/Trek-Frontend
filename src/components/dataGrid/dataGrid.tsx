            ...
            <div className="flex items-center gap-2">
                {totalPage > 3 && (
                    <button
                        ...
                        className="disabled:text-slate-400 border p-2 rounded-md w-8 h-8 flex items-center justify-center cursor-pointer"
                    >
                        <FaBackwardStep />
                    </button>
                )}
                ...
                {pageNumbers.map((page, idx) =>
                    typeof page === "number" ? (
                        <button
                            ...
                            className={`border  px-2 py-1 rounded-md w-8 h-8 flex items-center justify-center cursor-pointer ${page === currentPage ? "text-primary bg-primary-v6" : ""
                                }`}
                        >
                            {page}
                        </button>
                        ...
                        <span
                            key={idx}
                            className="border  px-2 py-1 rounded-md w-8 h-8 flex items-center justify-center"
                        >
                            {page}
                        </span>
                    )
            ...
            <div className="max-w-full overflow-x-auto custom-scrollbar">
                ...
                >
                    <thead className="border-gray-100 border-y bg-gray-50 dark:border-gray-800 dark:bg-gray-900">
                        <tr className="text-left text-para bg-primary-heading">
                    ...
                    `}
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span>{col.label}</span>
                                            {col?.icon && (
                                                <BsFilterLeft className="text-para/70" size={18} />
                                            )}
                        ...
                        {isLoading == false && data?.length > 0 && (
                            data.map((item, rowIndex) => {
                                ...
                                return (
                                    <tr
                                        key={rowIndex}
                                        className={`text-base bg-white group ${isShadow && "hover:shadow-lg"
                                    ...
                                    >
                                        {columns.map((col, colIndex) => {
                                            ...
                                            return (
                                                <td
                                                    key={String(colIndex)}
                                                    className={`py-3 min-w-[200px] ${isFirst ? "pl-3 rounded-l-md" : ""
