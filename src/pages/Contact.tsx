    ...
    <div className="pt-20">
      <section className="bg-gray-100 dark:bg-gray-800 py-20 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mt-4 max-w-3xl mx-auto">We'd love to hear from you! Whether you have a question about our tours or need help planning your next adventure, we're here to help.</p>
        </div>
      </section>
      ...
      <section className="py-20">
            ...
            <div className="space-y-6">
                <div className="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">123 Travel Lane, Adventure City, 98765</p>
                    </div>
                </div>
                 <div className="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">hello@heavenlypathways.com</p>
                    </div>
                </div>
                 <div className="flex items-start space-x-4">
                    <div className="bg-blue-100 dark:bg-blue-700/20 p-3 rounded-full"><span className="text-blue-700 text-2xl">📞</span></div>
       ...
       <div className="w-full h-96">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.086434444983!2d-122.42172048468135!3d37.78916987975661!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085809a6bbeb6d3%3A0x440212f1dbaa1843!2sSan%20Francisco%2C%20CA%2C%20USA!5e0!3m2!1sen!2s!4v1628892693892!5m2!1sen!2s"
                width="100%"
                height="100%"
                style={{ border: 0 }}
