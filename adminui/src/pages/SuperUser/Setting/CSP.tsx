...
const CSP = () => {
    ...
    const onSubmit = async (formData: FormCspConfig) => {
        try {
            ...
            if (response.Code === 200) {
                toaster.success("CSP Configuration saved successfully!");
            } else {
                toaster.error("Failed to save CSP Configuration.");
            }
        } catch (error: any) {
    ...
    return (
        <div className="grid grid-cols-1 gap-4">
            <ComponentCard title="CSP Configuration">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            Enable specific nonce generation for scripts.
                        </p>
                    </div>
