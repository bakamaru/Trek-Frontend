...
const File = () => {
    ...
    const onSubmit = async (formData: FormFileConfig) => {
        try {
            ...
            if (response.Code === 200) {
                toaster.success("File Configuration saved successfully!");
                setEditingIds(new Set());
            } else {
                toaster.error("Failed to save File Configuration.");
            }
        } catch (error: any) {
    ...
    return (
        <div className="grid grid-cols-1 gap-4">
            <ComponentCard title="File Configuration">
                                                ...
                                                <tr key={field.id}>
                                                    <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11 align-top">
                                                        {isEditing ? (
                                                            <div className="flex items-center gap-2">
                                                                <input
                                                                    type="text"
                                                                    className={`w-full rounded border-[1.5px] bg-transparent px-5 py-3 font-medium outline-none transition disabled:cursor-default disabled:bg-whiter dark:bg-form-input ${errors.FileTypes?.[index]?.Extension
                                                                    ...
                                                                    {...register(`FileTypes.${index}.Extension`, {
                                                                        ...
                                                                        validate: (value) => {
                                                                            ...
                                                                            return isDuplicate ? "Extension must be unique" : true;
                                                                        },
                                                                    })}
                                                                />
                                                                <button
                                                            ...
                                                            render={({ field: { onChange, value } }) => {
                                                                ...
                                                                const addTag = (newTag: string) => {
                                                                    ...
                                                                    if (!mimeRegex.test(trimmed)) {
                                                                        toaster.error(`Invalid MIME type: "${trimmed}". Expected format: type/subtype`);
                                                                        return;
                                                                    }
                                                                ...
                                                                return (
                                                                    <div className="w-full">
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            className="w-full rounded border-[1.5px] border-stroke bg-transparent px-3 py-2 text-sm font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                                                            placeholder="Type MIME and press Enter (e.g. image/png)"
                                                                            onKeyDown={(e) => {
                                                                        ...
                                                                        <p className="mt-1 text-xs text-gray-500">
                                                                            Example: <code>image/png, image/x-png</code>
                                                                        </p>
                                                                    </div>
                                                                );
                                                            }}
                                                    ...
                                                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark text-right align-top">
                                                        <button
                                                            type="button"
                                                            onClick={() => {
                                                                if (window.confirm("Are you sure you want to delete this file type configuration?")) {
                                                                    remove(index);
                                                                }
                                                            }}
