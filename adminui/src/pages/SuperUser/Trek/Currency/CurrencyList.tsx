...
import { useDeleteCurrencyMutation, useGetAllCurrencyQuery } from "../../../../redux/trek/currencyAPI";
...
export default function CurrencyList() {
    ...
    const { data, isLoading, refetch } = useGetAllCurrencyQuery({ query: searchText, limit, offset, ...filterData });
    ...
    const handleDelete = async (id: number) => {
        try {
            ...
            toaster.error("An error occurred while deleting the currency.");
        }
    };
    ...
    return (
        <>
            <div className="space-y-6">
                <ComponentCard title="Currency List">
                    <>
