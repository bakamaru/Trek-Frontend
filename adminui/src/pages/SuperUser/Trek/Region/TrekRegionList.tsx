...
export default function TrekRegionList() {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (item: any) => (
                <Link
                    to={`/superadmin/trek/region/edit?id=${item?.TrekRegionId}`}
            ...
            render: (row: any) => (
                <div className="flex items-center gap-2">
                    <button
                        title="Edit"
                        onClick={() => {
                            navigate(`/superadmin/trek/region/edit?id=${row.TrekRegionId}`);
                        }}
    ...
    return (
        <>
            <div className="space-y-6">
                <ComponentCard title="Trek Region List">
                    <>
                        <div className="flex flex-col gap-5 px-6 mb-4 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="relative">
                                <button
                                    type="button"
                                    onClick={() => {
                                        navigate("/superadmin/trek/region/new");
                                    }}
