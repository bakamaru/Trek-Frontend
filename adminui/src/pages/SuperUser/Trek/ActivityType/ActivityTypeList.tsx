...
import { useDeleteActivityTypeMutation, useGetAllActivityTypeQuery } from "../../../../redux/trek/activityTypeAPI";
...
export default function ActivityTypeList() {
    ...
    const { data, isLoading, refetch } = useGetAllActivityTypeQuery({ query: searchText, limit, offset, ...filterData });
    ...
    const handleDelete = async (id: number) => {
        try {
            ...
            if (response.code == 200) {
                ...
                toaster.error("Failed to delete activity type!");
            }
        } catch (error) {
            toaster.error("An error occurred while deleting the activity type.");
        }
    };
