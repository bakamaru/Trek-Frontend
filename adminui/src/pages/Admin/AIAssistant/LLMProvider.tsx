  ...
  const handleDelete = async (id: number) => {
    try {
      ...
      if (response.Code == 200) {
        //toastSuccess("LLM Provider deleted successfully");
        toaster.success("LLM Provider has been delete successfully!")
        refetch();
      } else {
        toaster.error("Failed to delte LLM Provider!")
      }
  ...
  return (
    <>
      <div className="space-y-6">
        <ComponentCard title="LLM Providers">
          <>
