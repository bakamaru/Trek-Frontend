...
const Moderation = () => {
    ...
    return (
        <>
            <ComponentCard title="Moderation Logs">
                ...
                {IsStatsLoading ? (
                    ...
                    <div className="flex gap-4">
                        <div>Total Queries: {StatsData.Data.TotalQueries}</div>
                        <div>Flagged Queries: {StatsData.Data.FlaggedQueries}</div>
                        <div>Blocked Queries: {StatsData.Data.BlockedQueries}</div>
                    </div>
                ) : (
            ...
            >
                {SelectedLog && (
                    <ComponentCard title="Moderation Log Detail">
                        <p>AI Assistant ID: {SelectedLog.AiAssistantId}</p>
                        <p>User ID: {SelectedLog.UserId}</p>
                        <p>Timestamp: {SelectedLog.Timestamp}</p>
                        <p>Query: {SelectedLog.Query}</p>
                        <p>Response: {SelectedLog.Response}</p>
                        <p>Is Blocked: {SelectedLog.IsBlocked ? "Yes" : "No"}</p>
                        <p>Flagged: {SelectedLog.Flagged ? "Yes" : "No"}</p>
                    </ComponentCard>
                )}
            </Modal>
        </>
