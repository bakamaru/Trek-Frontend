    ...
    const onSubmit = async (formData: IdentityResourceDto) => {
        try {
            ...
            if (isEditMode) {
                ...
                toaster.success("Identity Resource updated successfully!");
            } else {
                const response = await createIdentityResource(apiData).unwrap();
                toaster.success("Identity Resource created successfully!");
            }
        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div className="grid grid-cols-1 gap-4">
                    <ComponentCard title={`${isEditMode ? "Edit" : "New"} Identity Resource`}>
                        <InputField
                            type="text"
                            id="name"
                            labelName="Name"
                        ...
                        />
                        {isEditMode && (
                            <p className="text-xs text-gray-500 -mt-2">Name cannot be changed after creation</p>
                        )}
                        ...
                        <InputField
                            ...
                            placeholder="e.g., OpenID, User Profile"
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                rows={4}
                                placeholder="Describe this identity resource..."
