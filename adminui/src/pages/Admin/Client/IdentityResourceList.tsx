...
export default function IdentityResourceList() {
            ...
            render: (row: any) => (
                <div className="flex items-center gap-2">
                    ...
                    <button
                        title="Delete"
                        onClick={() => {
                            if (confirm("Are you sure you want to delete this identity resource?")) {
                                handleDelete(row.id);
                            }
                        }}
    ...
    const handleDelete = async (id: string) => {
        try {
            ...
            toaster.success("Identity Resource deleted successfully!");
            refetch();
        } catch (error) {
            console.error(error);
            toaster.error("An error occurred while deleting the identity resource.");
        }
    };
    ...
    return (
        <div className="space-y-6">
            <ComponentCard title="Identity Resource Management">
                <>
