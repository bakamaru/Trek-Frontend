...
export default function ApiScopeList() {
            ...
            render: (row: any) => (
                <div className="flex items-center gap-2">
                    ...
                    <button
                        title="Delete"
                        onClick={() => {
                            if (confirm("Are you sure you want to delete this API scope?")) {
                                handleDelete(row.id);
                            }
                        }}
    ...
    const handleDelete = async (id: string) => {
        try {
            ...
            toaster.success("API Scope deleted successfully!");
            refetch();
        } catch (error) {
            console.error(error);
            toaster.error("An error occurred while deleting the API scope.");
        }
    };
    ...
    return (
        <div className="space-y-6">
            <ComponentCard title="API Scope Management">
                <>
