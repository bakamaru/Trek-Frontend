  ...
  return (
    <div className="space-y-4">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <ComponentCard title={isEditMode ? "Edit Role" : "Add Role"}>
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <Checkbox label="System" {...register("IsSystem")} id="isSystem" />
              <Checkbox label="Temporary" {...register("IsTemporary")} id="isTemporary" />
            </div>
          </div>
        </ComponentCard>
