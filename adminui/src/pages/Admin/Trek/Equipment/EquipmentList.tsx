...
import { useDeleteEquipmentMutation, useGetAllEquipmentQuery } from "../../../../redux/trek/equipmentAPI";
...
export default function EquipmentList() {
    ...
    const { data, isLoading, refetch } = useGetAllEquipmentQuery({ query: searchText, limit, offset, ...filterData });
    ...
    const handleDelete = async (id: number) => {
        try {
            ...
            if (response.Code == 200) {
                ...
                toaster.error("Failed to delete equipment!");
            }
        } catch (error) {
            toaster.error("An error occurred while deleting the equipment.");
        }
    };
    ...
    return (
        <>
            <div className="space-y-6">
                <ComponentCard title="Equipments">
                    <>
