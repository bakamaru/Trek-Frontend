      ...
      <div className="flex items-center gap-3">
        ...
        {children && (
          <div className="relative" ref={filterRef}>
            ...
            {isFilterOn && (
              <div className="bg-white border rounded-md border-gray-300 flex flex-col gap-2 z-10 fixed bottom-0 left-0 w-full md:absolute md:top-12 md:right-0 md:w-[30rem] md:bottom-auto md:left-auto">
                ...
                <div className="border-t border-gray-300 px-2 py-2 flex items-center justify-end gap-4">
