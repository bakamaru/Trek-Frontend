...
const VideoPlayer: React.FC<{ url: string; autoPlay?: string }> = ({ url, autoPlay }) => {
    if (!url) return <div className="aspect-video bg-gray-200 flex items-center justify-center text-gray-500">No URL provided</div>;
...
export const GenericBlockRenderer: React.FC<BlockRendererProps> = ({ settings, content, htmlTemplate, apiConfig, onEditIcon }) => {
    ...
    if (!htmlTemplate) return <div className="p-4 bg-red-50 text-red-500">Missing HTML Template</div>;
