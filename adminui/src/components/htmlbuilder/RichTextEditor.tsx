  ...
  return (
    <div className="border border-gray-300 rounded-lg overflow-hidden bg-white focus-within:ring-2 focus-within:ring-blue-500 transition-shadow">
      <div className="flex items-center gap-1 p-2 bg-gray-50 border-b border-gray-200">
        ...
        <ToolbarButton onClick={() => execCommand('formatBlock', 'H3')} icon={<Heading1 size={14} />} title="Large Heading" />
        <ToolbarButton onClick={() => execCommand('formatBlock', 'H4')} icon={<Heading2 size={14} />} title="Small Heading" />
        <ToolbarButton onClick={() => execCommand('formatBlock', 'P')} icon={<Type size={14} />} title="Paragraph" />
        <div className="w-px h-4 bg-gray-300 mx-1" />
