...
const sunavItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Settings",
    subItems: [
      { name: "Content Security Policy", path: "/superadmin/csp", pro: false },
      { name: "API Config", path: "/superadmin/config/api", pro: false },
      { name: "Optimiztion", path: "/superadmin/optimization", pro: false },
      { name: "OTP", path: "/superadmin/otp", pro: false },
      { name: "Email Config", path: "/superadmin/config/email", pro: false },
      { name: "SMS Config", path: "/superadmin/config/sms", pro: false },
      { name: "File", path: "/superadmin/config/file", pro: false },
      { name: "Web Setting", path: "/superadmin/config/web", pro: false },
      { name: "Caching", path: "/superadmin/config/caching", pro: false },
    ],
  },
  {
    icon: <SystemIcon />,
...
const AppSidebar: React.FC = () => {
  ...
  if (Array.isArray(userRoles)) {
    if ((userRoles as string[]).includes("SuperAdmin")) {
      isUsersuperadmin = true;
    }
    if ((userRoles as string[]).includes("Admin")) {
  ...
  useEffect(() => {
    ...
    ["main", "others"].forEach((menuType) => {
      ...
      const items = menuType === "main" ? (isUsersuperadmin == true ? sunavItems : adminnavItems) : othersItems;
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            <div>
              ...
              {renderMenuItems((isUsersuperadmin == true ? sunavItems : adminnavItems), "main")}
            </div>
            {/* <div className="">
              <h2
                className={`mb-4 text-xs uppercase flex leading-[20px] text-gray-400 ${!isExpanded && !isHovered
